...
public class TheDocumentCreator {
                ...
                list.stream().forEach(vo -> {
                    try {
                        if (vo.getHierarchy() != null) {
                            ...
                            populateDocumentObject(list2,doc);
     ...
     * @param obj
     */
    private static void populateDocumentObject(List<String> hrkeyData, Object obj) {
        if (hrkeyData.size() == 1) {
            ...
            try {
                ...
                if (elmnt.startsWith("$")) {
                    ...
                    if (objectField.get(obj) == null) {
                        ...
                        hrkeyData.remove(0);
                        populateDocumentObject(hrkeyData,((List)objectField.get(obj)).get(i));
                    ...
                    hrkeyData.remove(0);
                    populateDocumentObject(hrkeyData,objectField.get(obj));
                }
